...
function setupAccessGuard(router: Router) {
  router.beforeEach(async (to, from) => {
    ...
    await authStore.initPermissionState();
    const filteredRoutes = filterConsoleRoutesByMenuKeys(
      accessRoutes,
      permissionStore.menuKeys,
    );
    const resolvedHomePath =
      userInfo.homePath ||
      findFirstConsoleAccessiblePath(filteredRoutes) ||
      preferences.app.defaultHomePath;
