...
func openRoleServiceTestContext(t *testing.T) (database.Repo, *pkgcasbin.Enforcer, string) {
	t.Helper()
...
CREATE TABLE IF NOT EXISTS console_casbin_rules (
	...
	enforcer, err := pkgcasbin.New(db, &pkgcasbin.Config{TableName: "console_casbin_rules"})
	if err != nil {
